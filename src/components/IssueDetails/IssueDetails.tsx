...
import {ISSUE_DETAILS_QUERY, IssueDetailsParam, IssueDetailsResponse} from "./IssueDetailsQuery";
...
const DetailsComponent:FunctionComponent<{ issue:IssueDetail }> = ({issue})=> {
      ...
      <Divider orientation="left">Comments</Divider>
      {
        issue.comments.edges.map(({node:comment})=>{
          return <React.Fragment>
            <Divider orientation="left">{comment.author.login} replied</Divider>
            <br />
